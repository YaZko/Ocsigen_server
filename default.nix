...
stdenv.mkDerivation {
    ...
    buildInputs = [ocaml findlib merlin eliom ocsigen_server ocsigen_deriving js_of_ocaml ocaml_ssl ocamlnet ocaml_pcre cryptokit ocaml_sqlite3 ocaml_batteries];
