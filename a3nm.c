// This code belongs to hackEns team which won the contest. Taken from here: http://a3nm.net/blog/google_hashcode_2015.html
// Borrowed to generate solutions in order to test the server
